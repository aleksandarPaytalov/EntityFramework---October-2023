...
public class StartUp
{
    ...
    {
        var productsSoldWithBuyer = context.Users
        ...
        var output = new
        {
            usersCount = productsSoldWithBuyer.Count(),
            users = productsSoldWithBuyer
                .Select( u=> new
            {
                u.firstName,
                u.lastName,
        ...
        var productsSoldWithBuyerJson = JsonConvert.SerializeObject(output, new JsonSerializerSettings
        {
            Formatting = Formatting.Indented,
            NullValueHandling = NullValueHandling.Ignore
        });

        return productsSoldWithBuyerJson;
    }
}
